...
(function ($) {
    ...
    var bs = {
        3: {
            ...
            icons: {
                ...
                /*begin 2018-12-16 zhangyuankang for:为表格的删除按钮增加方法*/
                delete:"glyphicon glyphicon-trash"
               /*end 2018-12-16 zhangyuankang for:为表格的删除按钮增加方法*/
            },
            pullClass: 'pull',
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        // showColumns, showToggle, showRefresh,showDelete
        ...
        if(this.options.showDelete){
          html.push(sprintf('<button class="btn' +
            sprintf(' btn-%s', this.options.buttonsClass) +
            sprintf(' btn-%s', this.options.iconSize) +
            '" type="button" name="delete" aria-label="delete" title="%s">',
            this.options.formatDelete()),
            sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.delete),
            '</button>');
        }
        /*end 2018-12-16 zhangyuankang for:为表格的删除按钮增加方法*/
        ...
        /*begin 2018-12-16 zhangyuankang for:为表格的删除按钮增加方法*/
        if(this.options.showDelete && this.options.deleteCallback
          && Object.prototype.toString.call(this.options.deleteCallback) ==="[object Function]")
        {
          this.$toolbar.find('button[name="delete"]')
            .off('click').on('click', $.proxy(this.options.deleteCallback, this));
        }
        /*end 2018-12-16 zhangyuankang for:为表格的删除按钮增加方法*/
        if (this.options.showToggle) {
